...
public class CareerCounsultancyApplication {
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(CareerCounsultancyApplication.class, args);
	...
	public SessionFactory getSessionFactory(DataSource dataSource) throws IOException
	{
		...
		localSessionFactoryBean.setPackagesToScan(new String[] {"com.careerconsultancy"});
